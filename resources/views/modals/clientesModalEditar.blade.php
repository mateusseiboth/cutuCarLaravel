    ...
    <div class="modal-dialog">
        <div class="modal-content corzinha">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('editar-cliente', ['id' => $cliente->id]) }}" id="form-client"
                    name="form-client">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group col-mb-3">
                            ...
                            <input placeholder="Informe o nome do cliente" value="{{ $cliente->nome }}" type="text"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group col-mb-3">
                            ...
                            <input placeholder="Informe o CPF do cliente" value="{{ $cliente->cpf }}" type="text"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group col-mb-3">
                            ...
                            <input placeholder="Informe o telefone do cliente" value="{{ $cliente->telefone }}"
