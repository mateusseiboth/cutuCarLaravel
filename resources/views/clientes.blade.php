        ...
        <div class="modal-dialog">
            <div class="modal-content corzinha">
                ...
                <div class="modal-body">
                    ...
                    <!-- Formulário de inserção/edição de clientes -->
                    <form method="POST" action="{{ route('editar-cliente', ['id' => $cliente->id]) }}" id="form-client" name="form-client">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="action" value="save_cliente">
                        <input type="hidden" name="id" value="">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group col-mb-3">
                                ...
                                <input placeholder="Informe o nome do cliente" value="{{ $cliente->nome }}" type="text" name="nome" id="nome"
                                    class="form-control">
                                <small id="msgNome" class="form-text text-danger"></small>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group col-mb-3">
                                ...
                                <input placeholder="Informe o CPF do cliente" value="{{ $cliente->cpf }}" type="text" name="cpf"
                                    id="cpf" class="form-control">
                                <small id="msgCpf" class="form-text text-danger"></small>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group col-mb-3">
                                ...
                                <input placeholder="Informe o telefone do cliente" value="{{ $cliente->telefone }}" type="text" name="telefone"
                                    id="telefone" class="form-control">
                                <small id="msgTelefone" class="form-text text-danger"></small>
                            </div>
                        </div>
